...
class TmohentaiGalleryExtractor(GalleryExtractor):
    ...
    def images(self, page):
        fmt = f"https://imgrojo.tmohentai.com/contents/{self.gallery_id}/{{:>03}}.webp".format
        cnt = page.count('class="lanzador')
        return [(fmt(i), None) for i in range(cnt)]
    ...
    def metadata(self, page):
        ...
        return {
            ...
            "artists": text.split_html(extr("<label>Artists and Artists Groups</label>", "</ul>")),
