...
class VichanThreadExtractor(VichanExtractor):
    ...
    def _process(self, post, data):
        ...
        post["url"] = "{}/{}/src/{}{}".format(self.root, post["board"], post["tim"], post["ext"])
    ...
    def _process_8kun(post, data):
        ...
        tim = post["tim"]
        if len(tim) > 16:
            post["url"] = "https://media.128ducks.com/file_store/{}{}".format(tim, post["ext"])
        else:
    ...
    def items(self):
        ...
        for page in threads:
            for thread in page["threads"]:
                url = "{}/{}/res/{}.html".format(self.root, self.board, thread["no"])
